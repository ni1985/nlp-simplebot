...
# create a chat window as a scrolled text widget
chatWindow = tks.ScrolledText(baseWindow, font="Arial")

# Tags for message alignment: 'tag-left' for bot messages, 'tag-right' for user messages
...
# place tyhe chat window, user bow and the send button on the main window
